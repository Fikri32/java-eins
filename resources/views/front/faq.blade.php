            ...
            <div class="panel-group" id="accordion">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title text-left">
                            <a class="btn btn-block text-left" data-toggle="collapse" data-parent="#accordion"
                                href="#collapse1" style="border:0.2rem solid #c5c5c5;font-size:2.1rem">
                                Coconut Charcoal Payment Terms?
                                <i class="fa fa-angle-down float-right" style="margin-top: 4px;margin-left: 2px;"></i>
                            </a>
                        </h4>
                    </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title text-left">
                            <a class="btn btn-block text-left" data-toggle="collapse" data-parent="#accordion"
                                href="#collapse2" style="border:0.2rem solid #c5c5c5;font-size:2.1rem">
                                How to Order?  
                                <i class="fa fa-angle-down float-right" style="margin-top: 4px;margin-left: 2px;"></i>    
                            </a>
                        </h4>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title text-left">
                            <a class="btn btn-block text-left" data-toggle="collapse" data-parent="#accordion"
                                href="#collapse3" style="border:0.2rem solid #c5c5c5;font-size:2.1rem">
